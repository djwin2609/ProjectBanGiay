...
<body>
	...
	<div class="product-list">
		<%
		List<ProductDetailBean> list = (List<ProductDetailBean>) request.getAttribute("dssanpham");//lấy danh sách sản phẩm từ servlet gửi đến
		//Dùng hashset để lưu các giá trị duy nhất tránh trùng các sản phẩm
		...
		%>
		<a href="ProductDetailConTroller?id=<%=p.getProductID()%>"
			class="product-link">
			<div class="product">
				<img
					src="<%=(p.getImage() != null) ? p.getImage() : "images/default.png"%>"
					alt="<%=p.getProductName()%>">

				<h3><%=p.getProductName()%></h3>

				<p><%=String.format("%,.0f", p.getPrice())%>₫
				</p>
